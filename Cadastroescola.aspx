                    ...
                    <div class="mdl-grid" style="margin-top: 0px; padding: 0px; margin-left: 0px;">
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 95%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_nome" runat="server" CssClass="mdl-textfield__input" ToolTip="Nome completo da escola" MaxLength="60"></asp:TextBox>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 80%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_endereco" runat="server" CssClass="mdl-textfield__input" ToolTip="Endereço sem o numero" MaxLength="80"></asp:TextBox>
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 15%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_numend" runat="server" CssClass="mdl-textfield__input" ToolTip="Numero do endereço" MaxLength="6"></asp:TextBox>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 40%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_bairro" runat="server" CssClass="mdl-textfield__input" ToolTip="Bairro da escola" MaxLength="15"></asp:TextBox>
                                <asp:Label for="ESC_bairro" runat="server" Text="Bairro" CssClass="mdl-textfield__label"></asp:Label>
                            </div>

                            <!--cidade-->
                            <div class="mdl-textfield mdl-js-textfield" style="width: 40%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_cidade" runat="server" CssClass="mdl-textfield__input" ToolTip="Cidade da escola" MaxLength="45"></asp:TextBox>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 35%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_cep" runat="server" CssClass="mdl-textfield__input" ToolTip="CEP do endereço" TextMode="Number" MaxLength="8"></asp:TextBox>
                            ...
                            <!--telefone-->
                            <div class="mdl-textfield mdl-js-textfield" style="width: 35%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_tel" runat="server" CssClass="mdl-textfield__input" ToolTip="Telefone principal da escola" TextMode="Number" MaxLength="10" EnableViewState="True"></asp:TextBox>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 45%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_cnpj" runat="server" CssClass="mdl-textfield__input" ToolTip="CNPJ da escola" TextMode="Number" MaxLength="20"></asp:TextBox>
                            ...
                            <!--ie-->
                            <div class="mdl-textfield mdl-js-textfield" style="width: 45%; margin-right: 10px;">
                                <asp:TextBox ID="ESC_ie" runat="server" CssClass="mdl-textfield__input" ToolTip="Inscrição Estadual da escola" TextMode="Number" MaxLength="15"></asp:TextBox>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="mdl-textfield mdl-js-textfield" style="width: 100%;">
                                <asp:TextBox ID="ESC_email" runat="server" CssClass="mdl-textfield__input" ToolTip="Email principal da escola" TextMode="Email" MaxLength="45"></asp:TextBox>
                        ...
                        <div style="text-align: center; width: 100%; margin-top: 5%">
                            <asp:Button ID="btnsalvar" runat="server" Text="Salvar novo" CssClass="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" OnClick="btnsalvar_Click1" />
